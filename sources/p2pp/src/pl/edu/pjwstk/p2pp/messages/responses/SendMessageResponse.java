...
public class SendMessageResponse extends Response {
	 ...
	 */
	public SendMessageResponse(boolean[] protocolVersion, boolean[] messageType, boolean isAcknowledgment, boolean isSentByPeer, boolean isRecursive,
                               boolean[] responseCode, byte ttl, byte[] transactionID, byte[] sourceID, byte[] responseID, boolean isOverReliable,
                               boolean isEncrypted, PeerInfo responseOriginatorPeerInfo) {
		super(protocolVersion, messageType, isAcknowledgment, isSentByPeer, isRecursive, responseCode,
				P2PPMessage.SEND_MESSAGE_MESSAGE_TYPE, ttl, transactionID, sourceID, responseID, isOverReliable, isEncrypted);
	...
	public void addObject(GeneralObject object) throws UnsupportedGeneralObjectException {
		if (object instanceof PeerInfo) {
			...
			throw new UnsupportedGeneralObjectException("SendMessageResponse can't contain " + object.getClass().getName() + " as object.");
		}
	}
	...
	public String toString() {
		StringBuilder builder = new StringBuilder("SendMessageResponse=[message=[" + super.toString() + "], header=["
