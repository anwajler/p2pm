...
public class DefaultAlgorithm_Test {
	...
	/*
	 * Default this node id = 12340
	 */
	
	@Test
	public void DefaultAlgorithm_isForwardingNeeded1_Test(){
		/*
		 * Unstructured overlay - request originator's id > this node's id
		 */
	...
	public void DefaultAlgorithm_isForwardingNeeded2_Test(){
		/*
		 * DHT-based overlay - request originator's distance > this node's 
		 * distance
		 */
		logger.trace("\nEntering test 2....");
	...
	public void DefaultAlgorithm_isForwardingNeeded4_Test(){
		/*
		 * Unstructured overlay - request originator's id < this node's 
		 * id
		 */
		...
		SubscribeRequest req = new SubscribeRequest(
				 7000,
				 new NodeInfo("12339", "10.69.40.111", 
				 "tiia", 9070),
				 new NodeInfo("12342", "10.69.40.222", 
				 "tiia2", 9072), "Software developement",
				 100000000, 20, -1);
	...
	public void DefaultAlgorithm_onDeliverCreateTopicWithSubscribeResponse_Test(){
		...
		StandardResponse res = new StandardResponse(1,
				                                    PubSubConstants.RESP_SUCCESS,
				                                    new NodeInfo("12398", "192.96.45.4", "source", 7890),
				                                    new NodeInfo("dest"),
				                                    topic.getID());
	...
	public void DefaultAlgorithm_onDeliverCreateTopicResponse_Test(){
		...
		StandardResponse res = new StandardResponse(2,
				                                    PubSubConstants.RESP_SUCCESS,
				                                    new NodeInfo("12398", "192.96.45.4", "source", 7890),
				                                    new NodeInfo("dest"),
				                                    "Plants");
	...
	public void DefaultAlgorithm_onDeliverCreateTopicResponse_AlreadyExists_Test(){
		...
		StandardResponse res = new StandardResponse(3,
				                                    PubSubConstants.RESP_ALREADYEXISTS,
				                                    new NodeInfo("12398", "192.96.45.4", "source", 7890),
				                                    new NodeInfo("dest"),
				                                    "Plants");
		pubsubmngr.onDeliverResponse(res);
	...
	public void DefaultAlgorithm_createTopic_DoesNotExist_Test(){
		...
		StandardResponse res = new StandardResponse(4,
                                                    PubSubConstants.RESP_SUCCESS,
                                                    new NodeInfo("12398", "192.96.45.4", "source", 7890),
                                                    new NodeInfo("dest"),
                                                    "Plants");
	...
	public void DefaultAlgorithm_onDeliverResponse_TransactionDoesNotExist_Test(){
		...
		StandardResponse res = new StandardResponse(5,
                                                    PubSubConstants.RESP_SUCCESS,
                                                    new NodeInfo("12398", "192.96.45.4", "source", 7890),
                                                    new NodeInfo("dest"),
                                                    "Plants");
	...
	public void DefaultAlgorithm_onDeliverCreateTopicResponse_CustomAC_Test(){
		...
		ac.getRule(PubSubConstants.OPERATION_SUBSCRIBE).addUser(PubSubConstants.EVENT_ALL,
				                                                new Subscriber("allowed", modTopic));
	...
	public void DefaultAlgorithm_onDeliverPublishTopicResponse_Accepted_Test(){
		...
		StandardResponse res = new StandardResponse(6,
                PubSubConstants.RESP_SUCCESS,
                new NodeInfo("12398", "192.96.45.4", "source", 7890),
                new NodeInfo("dest"),
                "Plants");
	...
	public void DefaultAlgorithm_onDeliverPublishTopicResponse_Error_Test(){
		...
		StandardResponse res = new StandardResponse(7,
                PubSubConstants.RESP_FORBIDDEN,
                new NodeInfo("12398", "192.96.45.4", "source", 7890),
                new NodeInfo("dest"),
                "Plants");
		pubsubmngr.onDeliverResponse(res);
	...
	public void DefaultAlgorithm_onDeliverPublishTopicResponse_RemoveTopic_Test(){
		...
		StandardResponse res = new StandardResponse(8,
                PubSubConstants.RESP_SUCCESS,
                new NodeInfo("12398", "192.96.45.4", "source", 7890),
                new NodeInfo("dest"),
                "Plants");
	...
	public void DefaultAlgorithm_onDeliverPublishTopicResponse_ModifyAC_Test(){
		...
		StandardResponse res = new StandardResponse(9,
                PubSubConstants.RESP_SUCCESS,
                new NodeInfo("12398", "192.96.45.4", "source", 7890),
                new NodeInfo("dest"),
                "Plants");
	...
	public void DefaultAlgorithm_onDeliverSubscribeResponse_Accepted_Test(){
		...
		StandardResponse res = new StandardResponse(10,
                PubSubConstants.RESP_SUCCESS,
                new NodeInfo("12398", "192.96.45.4", "source", 7890),
                new NodeInfo("dest"),
                "Vivarium");
	...
	public void DefaultAlgorithm_onDeliverSubscribeResponse_Rejected_Test(){
		...
		StandardResponse res = new StandardResponse(11,
                PubSubConstants.RESP_DOESNOTEXIST,
                new NodeInfo("12398", "192.96.45.4", "source", 7890),
                new NodeInfo("dest"),
                "Vivarium");
		pubsubmngr.onDeliverResponse(res);
	...
	public void DefaultAlgorithm_onDeliverPublishRequest_ByRootInterestingEvent_Test(){
		...
		PublishRequest req = new PublishRequest(
				 ...
				 "tiia", 9070),
				 new NodeInfo("67467", "10.69.40.222", 
				 "tiia2", 9072), "Software Developement",
	...
	public void DefaultAlgorithm_onDeliverPublishRequest_TwoChildrenWithDifferentIC_Test(){
		...
		SubscribeRequest req = new SubscribeRequest(
				 7000,
				 new NodeInfo("87654", "10.69.40.111", 
				 "tiia", 9070),
				 new NodeInfo("56844", "10.69.40.222", 
				 "tiia2", 9072), "Plants",
				 100000000, -1, 30);
		pubsubmngr.onDeliverRequest(req);
		
		String eventMessage = "Helo again ;)";
		PublishRequest preq = new PublishRequest(
				 7000,
				 new NodeInfo("12345", "10.69.40.111", 
				 "tiia", 9070),
				 new NodeInfo("67467", "10.69.40.222", 
