...
public class JCSyncMainTest {
    ...
    public JCSyncMainTest(String [] args){
    ...
    public void makeCollections() {
        ...
        try {
            try {
                 ...
                 */
                this.coll1 = (JCSyncHashMap) AbstractCollectionsManager.getInstance().requestCreateCollection(JCSyncHashMap.class, "map/hashMap1",EventInvoker.InvokerType.QUEUED);
