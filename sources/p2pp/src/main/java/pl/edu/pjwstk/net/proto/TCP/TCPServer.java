...
public class TCPServer extends Thread {
    ...
    public TCPServer(InetAddress address, int port, SupportedEncryption encryption, String keysPath, String passphrase) throws CertificateException,
            IOException, KeyManagementException, KeyStoreException, NoSuchAlgorithmException, UnrecoverableKeyException {
    ...
    public TCPServer(int port, SupportedEncryption encryption, String keysPath, String passphrase) throws CertificateException,
            IOException, KeyManagementException, KeyStoreException, NoSuchAlgorithmException, UnrecoverableKeyException {
        ...
        try {
            ...
            while (true) {
                ...
                try {
                    ...
                    //TCPServerThread tcpServerThread = new TCPServerThread(this, socket, socket.getInputStream());
...
class TCPServerThread extends Thread {
    ...
    private final static Logger LOG = Logger.getLogger(TCPServerThread.class);
