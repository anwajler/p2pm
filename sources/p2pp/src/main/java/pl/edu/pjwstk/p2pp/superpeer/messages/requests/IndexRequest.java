...
public class IndexRequest extends Request {
     ...
     */
    public IndexRequest(boolean[] protocolVersion, boolean isAcknowledgment, boolean isSentByPeer,
        ...
        super(protocolVersion, isAcknowledgment, isSentByPeer, isRecursive, P2PPMessage.INDEX_MESSAGE_TYPE, ttl,
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("IndexRequest=[message=[" + super.toString() + ", header=["
    ...
    public IndexResponse createResponse(boolean[] responseCode, PeerInfo ownPeerInfo, int expiresInSeconds) {
        ...
        return new IndexResponse(protocolVersion, P2PPMessage.RESPONSE_ACK_MESSAGE_TYPE, false, true, false, responseCode, (byte) 255,
                transactionID, sourceID, ownPeerInfo.getPeerID().getPeerIDBytes(), overReliable, encrypted, ownPeerInfo);
	}
}